  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className={cn('space-y-4', step !== 3 && 'hidden')}>
        ...
        <Field label="LinkedIn URL" name="linkedin_url" type="url" placeholder="https://linkedin.com/in/..." error={state.fieldErrors?.linkedin_url} />
        <div>
        ...
        <label className="flex items-start gap-2 text-sm text-slate-700">
          <input type="checkbox" name="terms_accepted" required className="mt-0.5 rounded border-slate-300" />
          <span>
        ...
        <FieldError message={state.fieldErrors?.terms_accepted} />
      </div>
